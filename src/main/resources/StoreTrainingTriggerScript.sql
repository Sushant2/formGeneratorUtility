...
CREATE TABLE `_TRAINING_1851313017` (
  `ID_FIELD` int(11) NOT NULL AUTO_INCREMENT,
  `ENTITY_ID` int(11) DEFAULT NULL,
  `CREATION_DATE` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `_TRAINING_PROGRAM_1993764527` varchar(255) DEFAULT NULL,
  `_DOCENTE_1100336825` varchar(255) DEFAULT NULL,
  `_DATA_INIZIO_CORSO_1826702253` date DEFAULT NULL,
  `_TRAINING_TYPE_361202941` int(11) DEFAULT NULL,
  `_SEDE_899569710` varchar(255) DEFAULT NULL,
  `_ATTENDEE_914804175` varchar(255) DEFAULT NULL,
  `_ATTENDEE_TITLE_1337424941` varchar(255) DEFAULT NULL,
  `_DATA_INIZIO_263203950` date DEFAULT NULL,
  `_COMPLETION_DATE_1614063954` date DEFAULT NULL,
  `_GRADE_1277710013` varchar(255) DEFAULT NULL,
  `_SCORE_1859514252` int(11) DEFAULT '-1',
  `PROCESSBY` varchar(255) DEFAULT NULL,
  `TARGET_DATABASE` varchar(255) DEFAULT NULL,
  `TENANT_ID` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID_FIELD`),
